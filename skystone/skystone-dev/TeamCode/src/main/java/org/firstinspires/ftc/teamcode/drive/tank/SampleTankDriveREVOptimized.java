...
public class SampleTankDriveREVOptimized extends SampleTankDriveBase {
    ...
    public SampleTankDriveREVOptimized(HardwareMap hardwareMap) {
        ...
        ExpansionHubMotor leftFront = hardwareMap.get(ExpansionHubMotor.class, "fl");
        ExpansionHubMotor leftRear = hardwareMap.get(ExpansionHubMotor.class, "bl");
        ExpansionHubMotor rightRear = hardwareMap.get(ExpansionHubMotor.class, "br");
        ExpansionHubMotor rightFront = hardwareMap.get(ExpansionHubMotor.class, "fr");
