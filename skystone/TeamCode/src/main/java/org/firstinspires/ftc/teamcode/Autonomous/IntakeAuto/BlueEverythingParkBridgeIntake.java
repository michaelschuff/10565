...
public class BlueEverythingParkBridgeIntake extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (!isStopRequested()) {
            ...
            drive.setLiftPower(liftController.update(drive.getLiftPos() / 1000.0));
    ...
    private Trajectory generateMoveToFirstStone() {
        if (SkystonePosition == 1) {
            ...
            return drive.trajectoryBuilder()
                    .splineTo(new Pose2d(-48, 35, Math.toRadians(-135)))
                    .build();
        } else {
            return drive.trajectoryBuilder()
                    .splineTo(new Pose2d(-56, 35, Math.toRadians(-135)))
                    .build();
        }
    }
    ...
    private Trajectory generateMoveToFoundation1() {
        return drive.trajectoryBuilder()
                ...
                .splineTo(new Pose2d(43.5, 35, Math.toRadians(90)))
                .build();
    }
    ...
    private Trajectory generateMoveToSecondStone() {
        if (SkystonePosition == 1) {
            ...
            return drive.trajectoryBuilder()
                    .splineTo(new Pose2d(0, 40, Math.toRadians(180)))
                    .splineTo(new Pose2d(-48 + 24, 35, Math.toRadians(-135)))
                    .build();
        } else {
            return drive.trajectoryBuilder()
                    .splineTo(new Pose2d(0, 40, Math.toRadians(180)))
                    .splineTo(new Pose2d(-57 + 24, 35, Math.toRadians(-135)))
                    .build();
        }
    }
    ...
    private Trajectory generateInsertBotSecond() {
        if (SkystonePosition == 1) {
            ...
            return drive.trajectoryBuilder()
                    .strafeTo(new Vector2d(-48 + 24, 30))
                    .build();
        } else {
            return drive.trajectoryBuilder()
                    .strafeTo(new Vector2d(-57 + 24, 30))
                    .build();
        }
    }
    ...
    private Trajectory generateMoveToFoundation2() {
        return drive.trajectoryBuilder()
                ...
                .splineTo(new Pose2d(43.5, 32, Math.toRadians(90)))
                .build();
    }
